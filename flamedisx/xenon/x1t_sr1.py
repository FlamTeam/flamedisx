...
# Backwards (for _compute), just copy forward direction
DEFAULT_S1_REVERSE_RECONSTRUCTION_BIAS_MEAN_PIVOT = 0.5948841302444277 # s_rec_bias_mean
DEFAULT_S2_REVERSE_RECONSTRUCTION_BIAS_MEAN_PIVOT = 0.49198507921078005 # s_rec_s2bias_mean
DEFAULT_S1_REVERSE_RECONSTRUCTION_BIAS_STD_PIVOT = 0.31763472112328395 # s_rec_bias_res
DEFAULT_S2_REVERSE_RECONSTRUCTION_BIAS_STD_PIVOT = 0.5272888301015638 # s_rec_s2bias_res
